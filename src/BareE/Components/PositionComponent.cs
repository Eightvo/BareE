...
namespace BareE.Components
{
    ...
    public class Pos
    {
        ...
        public static Pos Create(Vector3 pos, Vector3 lookat) { return Create(1.0f, pos, lookat, Vector3.UnitY); }
        public static Pos Create(Vector3 pos) { return Create(1.0f, pos, pos + Vector3.UnitZ, Vector3.UnitY); }
        public static Pos Create(float scale, Vector3 pos) { return Create(scale, pos, pos + Vector3.UnitZ, Vector3.UnitY); }
